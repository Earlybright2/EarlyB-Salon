...
export default function BarberDashboard() {
  ...
  const name = user?.name?.split(" ")[0] || "Barber";

  return (
    <DashboardLayout
      title="Barber Dashboard"
      subtitle={`Welcome back, ${name}. Manage your bookings and earnings.`}
      activeTab={activeTab}
      ...
      {activeTab === "overview" ? (
        <div className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatCard label="Appointments" value="0" hint="Upcoming this week" icon={CalendarDays} accent="bg-ebs-teal/10 text-ebs-teal" />
            ...
            <StatCard label="Profile Views" value="0" hint="Last 30 days" icon={Users} accent="bg-ebs-rose/10 text-ebs-rose" />
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl bg-ebs-bg-card border border-white/5 p-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-ebs-text-muted mt-0.5">
                      Get verified to start taking bookings.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ebs-text">Set your availability</p>
                    <p className="text-xs text-ebs-text-muted mt-0.5">
                      Let clients know when you're free.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ebs-text">Build your rating</p>
                    <p className="text-xs text-ebs-text-muted mt-0.5">
                      Great service earns great reviews.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                Complete KYC <ArrowRight className="h-4 w-4 ml-2" />
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-xl border border-ebs-warning/25 bg-ebs-warning/10 p-5 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-ebs-text-muted mt-1">
                Submit your documents to get verified and start accepting clients.
              </p>
            </div>
          </div>
          <Button
